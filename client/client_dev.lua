...
RegisterNetEvent('smdx-adminmenu:client:devoptions', function()
        ...
        options = {
            {
                ...
                event = 'smdx-adminmenu:client:horseoptions',
                arrow = true
            },
            {
                ...
                event = 'smdx-adminmenu:client:copycoordsmenu',
                arrow = true
            },
            {
                ...
                event = 'smdx-adminmenu:client:testanimation',
                arrow = true
            },
            {
                title = 'Entity Hash',
                ...
                event = 'smdx-adminmenu:client:gethash',
                arrow = true
            },
            {
                ...
                event = 'smdx-adminmenu:client:toggledoorid',
                arrow = true
            },
            {
                title = 'Ped Sawner',
                ...
                event = 'smdx-adminmenu:client:spawnped',
                arrow = true
            },
        }
    })
...
-- spawn admin horse
RegisterNetEvent('smdx-adminmenu:client:horseoptions', function()
    local option = {}
    ...
    TriggerEvent('smdx-adminmenu:client:spawnhorse', input[1])

end)

-- spawn horse / warp player / set networked
RegisterNetEvent('smdx-adminmenu:client:spawnhorse', function(HorseHash)
...
-- get entity hash
RegisterNetEvent('smdx-adminmenu:client:gethash', function()
...
-- npc/amimal spawner
RegisterNetEvent('smdx-adminmenu:client:spawnped', function()
    ...
    if not input then return end
    local hash = joaat(input[1])
    TriggerEvent('smdx-adminmenu:client:dospawnped', hash, input[2], input[3], input[4], input[5])
end)

RegisterNetEvent('smdx-adminmenu:client:dospawnped', function(hash, outfit, distance, freeze, dead)
